  ...
  return (
    <Container className="pb-24 pt-16 text-center lg:pt-24">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-semibold text-slate-900 sm:text-7xl">
        AI voice agents{' '}
        <span className="text-main-500 relative whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="fill-main-300/70 absolute left-0 top-2/3 h-[0.58em] w-full"
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/register" color='main' className='text-xl font-semibold px-6 py-3'>Join private beta</Button>
        {/* <Button
