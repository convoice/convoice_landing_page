...
const features: Array<Feature> = [
  {
    ...
    icon: function ReportingIcon() {
      return <ClockIcon className="h-6 w-6 text-main" aria-hidden="true" />;
    },
  },
  {
  ...
  },
  {
    ...
    icon: function ContactsIcon() {
      return <BookOpenIcon className="h-6 w-6 text-main" aria-hidden="true" />;
    },
  },
  {
  ...
  },
  {
    ...
    description:
      "We don’t offer this as part of our software but that statement is inarguably true. Accurate inventory tracking would help you for sure.",
    icon: function InventoryIcon() {
      return <MegaphoneIcon className="h-6 w-6 text-main" aria-hidden="true" />;
    },
  },
  {
    name: "Call Analytics",
  ...
  return (
    <div className={clsx(className, "overflow-hidden p-4")} {...props}>
      <div className="flex w-full flex-row gap-4">
        <div
          className={clsx(
            "h-10 w-10 rounded-lg p-2 outline outline-[1.8px] outline-main",
...
export function PrimaryFeatures() {
  return (
    <section
      ...
      className="bg-slate-100/80 pb-16 pt-8"
    >
      <Container>
        <div className="mx-auto mb-14 hidden max-w-2xl md:text-center">
          <p className="font-display text-sm font-semibold text-main-500 sm:text-base">
            HOW DOES IT WORK?
          </p>
          <h2 className="mt-2 max-w-2xl font-display text-3xl font-semibold text-slate-900 sm:text-4xl">
